...
export const defaultLayouts = {
  xl: [
    ...
    { i: 'practiceForm', x: 9, y: 1, w: 3, h: 19 },
    { i: 'accountInfo', x: 9, y: 2, w: 3, h: 16 },
    { i: 'userInfo', x: 0, y: 2, w: 9, h: 10 },
  ],
  lg: [
    { i: 'tvChart', x: 0, y: 0, w: 9, h: 28, minW: 4 },
    { i: 'practiceForm', x: 8, y: 1, w: 3, h: 12, minW: 3 },
    { i: 'accountInfo', x: 8, y: 2, w: 3, h: 16, minW: 3 },
  ...
  sm: [
    ...
    { i: 'practiceForm', x: 0, y: 1, w: 6, h: 16, minW: 2 },
    { i: 'accountInfo', x: 6, y: 1, w: 6, h: 16, minW: 2 },
    { i: 'userInfo', x: 0, y: 2, w: 12, h: 10, minW: 6 },
  ],
  xs: [
    { i: 'tvChart', x: 0, y: 0, w: 12, h: 25, minW: 6 },
    { i: 'practiceForm', x: 0, y: 1, w: 12, h: 12, minW: 2 },
    { i: 'accountInfo', x: 0, y: 2, w: 12, h: 16, minW: 2 },
    { i: 'userInfo', x: 0, y: 6, w: 12, h: 10, minW: 6 },
  ],
}
